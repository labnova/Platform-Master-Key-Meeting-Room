...
<input type="submit" value="ESCI" style="width: 7em; font-size:16px; float:right;"/> 
  ...
  <img src="logo.jpg" width="300"/ height="200" alt="logo_area51" style="display:inline-block;" />
...
<div class="sinistra">
  ...
  <div class="sidebar1">
 		...
 		<div class="video">
  		...
  		<iframe width="395" height="281" src="//www.youtube.com/embed/5E1NTRCbg2I" frameborder="0" allowfullscreen></iframe>
...
if(isset($nome) && isset($cognome)) {
  ...
  <div class="sidebar2">
   ...
   <div class="offerte">
        <h1>Offerte<span id="spryselect1"><span class="selectRequiredMsg">Please select an item.</span></span></h1>
