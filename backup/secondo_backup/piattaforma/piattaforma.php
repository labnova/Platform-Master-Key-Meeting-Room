...
<input type="submit" value="ESCI" style="width: 7em; font-size:16px; float:right;"/> 
  ...
  <img class="header" src="header.png"  alt="logo_area51" style=" float:left;"  />
...
<div class="sinistra">
  ...
  <div class="sidebar1">
 		...
 		<div class="video">
  		...
  		<iframe width="350" height="281" src="//www.youtube.com/embed/5E1NTRCbg2I" frameborder="0" allowfullscreen></iframe>
